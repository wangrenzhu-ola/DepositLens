...
struct PropertyRecord: Codable { var address: String; var sweep: SweepKind; var rooms: [RoomRecord]; var proposals: [ConditionProposal]; var cloudConsent = false; var startedAt = Date() }
